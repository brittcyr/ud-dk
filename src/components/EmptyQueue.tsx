...
function EmptyQueue() {
  return (
    <div className="styles__emptyState__M6Xjl">
      <i className="styles__icon__DijND styles__starIcon__XCpFE">
      ...
      <p>
        Use the star button in the player list to add a player to your queue.
      </p>
      <p>Queued players will appear here</p>
    </div>
  );
}
